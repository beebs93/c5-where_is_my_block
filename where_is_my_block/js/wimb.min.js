(function(e){WIMB.SearchForm=function(){var i=this,s=e("div.ccm-dashboard-page-container"),k=e("div.ccm-pane-body");e("div#bodyOverlay");var o=e("div.ccm-pane-footer"),f=e("div#ccm-dashboard-content form#wimb"),r=e("img#ccm-wimb-loading"),j=f.find("select"),p=j.filter('select[name="btid"]'),t=j.filter('select[name="ipp"]'),l=f.find('input[name="sort_by"]'),m=f.find('input[name="sort_dir"]'),q=f.find('input[name="ccm_paging_p"]'),g=f.find('input[name="refresh"]'),u=f.find('input[name="ccm_token"]'),
